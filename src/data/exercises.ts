...
export const EXERCISE_SEED: SeedExercise[] = [
  ...
  // ==================== CARDIO ====================
  { id: 'treadmill-run', name: 'Treadmill Run', muscleGroups: ['cardio'], category: 'compound', section: 'cardio', equipment: 'Machine', tracksDuration: true, defaultDuration: 30, defaultSets: 1, defaultRepsRange: [20, 30], defaultRestSeconds: 0 },
  { id: 'stationary-bike', name: 'Stationary Bike', muscleGroups: ['cardio', 'legs'], category: 'compound', section: 'cardio', equipment: 'Machine', tracksDuration: true, defaultDuration: 30, defaultSets: 1, defaultRepsRange: [15, 30], defaultRestSeconds: 0 },
  { id: 'rowing-machine', name: 'Rowing Machine', muscleGroups: ['cardio', 'back'], category: 'compound', section: 'cardio', equipment: 'Machine', tracksDuration: true, defaultDuration: 20, defaultSets: 1, defaultRepsRange: [15, 25], defaultRestSeconds: 0 },
  { id: 'jump-rope', name: 'Jump Rope', muscleGroups: ['cardio', 'calves'], category: 'compound', section: 'cardio', equipment: 'Other', tracksDuration: true, defaultDuration: 10, defaultSets: 3, defaultRepsRange: [30, 60], defaultRestSeconds: 60 },
  { id: 'elliptical', name: 'Elliptical', muscleGroups: ['cardio', 'legs'], category: 'compound', section: 'cardio', equipment: 'Machine', tracksDuration: true, defaultDuration: 30, defaultSets: 1, defaultRepsRange: [15, 30], defaultRestSeconds: 0 },
  { id: 'stair-master', name: 'Stair Master', muscleGroups: ['cardio', 'glutes', 'calves'], category: 'compound', section: 'cardio', equipment: 'Machine', tracksDuration: true, defaultDuration: 20, defaultSets: 1, defaultRepsRange: [15, 20], defaultRestSeconds: 0 },
  { id: 'battle-ropes', name: 'Battle Ropes', muscleGroups: ['cardio', 'shoulders'], category: 'compound', section: 'cardio', equipment: 'Other', tracksDuration: true, defaultDuration: 10, defaultSets: 3, defaultRepsRange: [15, 30], defaultRestSeconds: 60 },
  { id: 'sled-push', name: 'Sled Push', muscleGroups: ['cardio', 'legs'], category: 'compound', section: 'cardio', equipment: 'Machine', tracksDuration: true, defaultDuration: 10, defaultSets: 3, defaultRepsRange: [15, 30], defaultRestSeconds: 90 },
  { id: 'assault-bike', name: 'Assault Bike', muscleGroups: ['cardio'], category: 'compound', section: 'cardio', equipment: 'Machine', tracksDuration: true, defaultDuration: 15, defaultSets: 1, defaultRepsRange: [10, 20], defaultRestSeconds: 0 },

  // ==================== SPORTS ====================
  { id: 'swimming', name: 'Swimming', muscleGroups: ['full'], category: 'compound', section: 'sport', equipment: 'Other', tracksDuration: true, defaultDuration: 45, defaultSets: 1, defaultRepsRange: [30, 60], defaultRestSeconds: 0 },
  { id: 'badminton', name: 'Badminton', muscleGroups: ['shoulders', 'legs', 'cardio'], category: 'compound', section: 'sport', equipment: 'Other', tracksDuration: true, defaultDuration: 60, defaultSets: 1, defaultRepsRange: [30, 60], defaultRestSeconds: 0 },
  { id: 'tennis', name: 'Tennis', muscleGroups: ['shoulders', 'legs', 'cardio'], category: 'compound', section: 'sport', equipment: 'Other', tracksDuration: true, defaultDuration: 60, defaultSets: 1, defaultRepsRange: [30, 60], defaultRestSeconds: 0 },
  { id: 'basketball', name: 'Basketball', muscleGroups: ['legs', 'cardio'], category: 'compound', section: 'sport', equipment: 'Other', tracksDuration: true, defaultDuration: 60, defaultSets: 1, defaultRepsRange: [30, 60], defaultRestSeconds: 0 },
  { id: 'soccer', name: 'Soccer', muscleGroups: ['legs', 'cardio'], category: 'compound', section: 'sport', equipment: 'Other', tracksDuration: true, defaultDuration: 90, defaultSets: 1, defaultRepsRange: [30, 60], defaultRestSeconds: 0 },
  { id: 'martial-arts', name: 'Martial Arts', muscleGroups: ['full', 'core'], category: 'compound', section: 'sport', equipment: 'Other', tracksDuration: true, defaultDuration: 60, defaultSets: 1, defaultRepsRange: [30, 60], defaultRestSeconds: 0 },
  { id: 'rock-climbing', name: 'Rock Climbing', muscleGroups: ['back', 'biceps', 'forearms', 'core'], category: 'compound', section: 'sport', equipment: 'Other', tracksDuration: true, defaultDuration: 45, defaultSets: 1, defaultRepsRange: [20, 45], defaultRestSeconds: 0 },
  { id: 'boxing', name: 'Boxing', muscleGroups: ['shoulders', 'core', 'cardio'], category: 'compound', section: 'sport', equipment: 'Other', tracksDuration: true, defaultDuration: 45, defaultSets: 1, defaultRepsRange: [20, 45], defaultRestSeconds: 0 },
]
